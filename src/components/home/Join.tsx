    ...
    return (
        <div className='join_wrapper self-left content-left '>
            <div className="join_content">
                ...
                <p className='pt-6 text-[1.3rem] md:text-[1.6rem] md:leading-8 sm:pt-2' > At Riskout, we believe that the beauty of life lies in the little things that give us a better expression of ourselves, make us more social and connect emotionally. </p>
